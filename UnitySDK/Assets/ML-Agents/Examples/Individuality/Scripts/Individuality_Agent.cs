...
public class Individuality_Agent : Agent
{
    [Header("Specific to GridWorld")]
    private Individuality_Academy academy;
    ...
    {
        academy = FindObjectOfType(typeof(Individuality_Academy)) as Individuality_Academy;
    }
